...
The maximum number of juvenile hares were captured in 1999, and the number of juveniles captured decreased every year until 2004 after this. The minimum number caught were 0 in 2002 and 2009. The number captured tended to fluctuate.  The number captured each year also depends on the amount of sampling. If sampling cannot be consistent, it might be better to compare data that is standardized (such as number of juveniles caught by day) instead of comparing the years. 
...
#The following is used to rename values within the table. The dollar sign tells it to go to a specific column.
...
ggplot(data = weights_sex_viz, aes(x=sex, y=weight)) + 
  ...
  stat_summary(fun=mean, 
               ...
               color="black", 
               fill="black") +
  geom_point(data = juv_weights_summary, aes(x = sex, y = mean_weight))+
